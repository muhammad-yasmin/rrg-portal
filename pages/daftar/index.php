...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../dist/global/vendor/waves/waves.css">
        <link rel="stylesheet" href="../../dist/assets/examples/css/pages/login-v2.css">
    ...
    <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content">
        ...
        <div class="page-login-main">
          ...
          <h3 class="font-size-24">Daftar <i class="icon md-sign-in"></i></h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>

          <form method="post" action="../../config/pdaftar.php" autocomplete="off">
            <div class="form-group form-material floating" data-plugin="formMaterial">
              <input type="text" class="form-control empty" id="inputNama" name="nama_lengkap">
              <label class="floating-label" for="inputNama">Nama Lengkap</label>
            </div>
            <div class="form-group form-material floating" data-plugin="formMaterial">
            ...
            <div class="form-group form-material floating" data-plugin="formMaterial">
              <input type="password" class="form-control empty" id="ulangPassword" name="ulangpassword">
              <label class="floating-label" for="ulangPassword">Masukkan Ulang Password</label>
            </div>
